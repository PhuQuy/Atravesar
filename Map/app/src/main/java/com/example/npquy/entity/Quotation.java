...
public class Quotation {
	...
	public Quotation(Double viaLat, Double viaLong, Integer custid,
			Address pick, Double pickLat, Double pickLong, Double doffLat,
			Double doffLong, Address doff, Object via, String bookingdate,
			Integer paq, Integer bags, String note, Date returndate,
			Object rtnType, Boolean childseat, Boolean petfriendly,
			Boolean executive, String pickpostcode, String droppostcode,
			String viapostcode) {
		super();
		this.viaLat = viaLat;
	...
	public void setRtnType(Object rtnType) {
		this.rtnType = rtnType;
	}
	...
	public String toString() {
		return "Quotation [viaLat=" + viaLat + ", viaLong=" + viaLong
